...
CREATE TABLE 'questions' ('pkid' INTEGER PRIMARY KEY  NOT NULL , 'statement' VARCHAR NOT NULL, 'language' INTEGER NOT NULL, 'difficulty' INTEGER NOT NULL, 'discipline' INTEGER NOT NULL, FOREIGN KEY(language) REFERENCES language(pkid), FOREIGN KEY(difficulty) REFERENCES difficulty(pkid), FOREIGN KEY(discipline) REFERENCES discipline(pkid)) ;
CREATE TABLE 'answers' ('pkid' INTEGER PRIMARY KEY  NOT NULL , 'text' VARCHAR NOT NULL) ;
CREATE TABLE 'ans_que' ('pkid' INTEGER PRIMARY KEY  NOT NULL , 'answer' INTEGER NOT NULL, 'question' INTEGER NOT NULL, 'right' INTEGER NOT NULL NULL,FOREIGN KEY(question) REFERENCES questions(pkid),FOREIGN KEY(answer) REFERENCES answers(pkid)) ;
CREATE TABLE 'scoreboard' ('pkid' INTEGER PRIMARY KEY  NOT NULL , 'game_mode' VARCHAR NOT NULL, 'value' INTEGER NOT NULL) ;
